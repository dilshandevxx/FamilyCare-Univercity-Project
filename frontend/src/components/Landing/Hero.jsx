      ...
      >
        <div className="hero-text-container">
          ...
          <motion.div variants={itemVariants} style={{ display: 'flex', gap: '32px', marginTop: '48px' }}>
             <div>
                <h4 style={{ fontSize: '1.5rem', fontWeight: 'bold', margin: '0 0 4px', color: '#0f172a' }}>100+</h4>
                <p style={{ color: '#64748b', margin: 0, fontSize: '0.9rem' }}>Families</p>
             </div>
             <div style={{ width: '1px', background: 'rgba(0,0,0,0.1)' }}></div>
             <div>
                <h4 style={{ fontSize: '1.5rem', fontWeight: 'bold', margin: '0 0 4px', color: '#0f172a' }}>100+</h4>
                <p style={{ color: '#64748b', margin: 0, fontSize: '0.9rem' }}>Caregivers</p>
             </div>
             <div style={{ width: '1px', background: 'rgba(0,0,0,0.1)' }}></div>
             <div>
                <h4 style={{ fontSize: '1.5rem', fontWeight: 'bold', margin: '0 0 4px', color: '#0f172a' }}>98%</h4>
                <p style={{ color: '#64748b', margin: 0, fontSize: '0.9rem' }}>Satisfaction</p>
             </div>
          </motion.div>
        </div>
        ...
        <motion.div 
          ...
          style={{ padding: '40px', display: 'flex', flexDirection: 'column', gap: '24px', backgroundColor: 'white' }}
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
             ...
             <div>
               <p style={{ margin: '0 0 8px', fontStyle: 'italic', color: '#0f172a', lineHeight: 1.5 }}>
                 "FamilyCare completely transformed how we manage care for my mother. It gives us peace of mind every day."
               </p>
               <h5 style={{ margin: 0, fontWeight: '600', color: '#0f172a' }}>Sarah Mitchell</h5>
               <p style={{ margin: 0, fontSize: '0.85rem', color: '#64748b' }}>Family Member, Chicago</p>
             </div>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
             <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
                ...
                <span style={{ fontSize: '0.8rem', color: '#64748b' }}>Real-time</span>
             </div>
             <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '12px', background: 'rgba(16,185,129,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#10b981' }}>
                  <Shield size={20} />
                </div>
                <span style={{ fontSize: '0.8rem', color: '#64748b' }}>Secure</span>
             </div>
             <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '12px', background: 'rgba(16,185,129,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#10b981' }}>
                  <Clock size={20} />
                </div>
                <span style={{ fontSize: '0.8rem', color: '#64748b' }}>24/7 Access</span>
             </div>
          </div>
